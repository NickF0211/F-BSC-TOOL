...
def run_exp(command_header):
    ...
    with open("approve_req_rule_template_fol.txt", 'r') as rule_template:
    ...
    rule_file = "approve_req_rule_unbound_fol.py"
    with open(outfile, 'w') as out_f:
    ...
    result_file = "results/approve_req_unbound_fol.txt"
    print(result_file)
    with open(result_file, 'w') as f:
        try:
