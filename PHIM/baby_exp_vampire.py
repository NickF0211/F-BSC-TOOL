...
def run_exp(command_header):
    ...
    with open("baby_rule_template_vampire.txt", 'r') as rule_template:
    ...
    rule_file = "baby_rule_unbounded_vampire.py"
    ...
    for j in range(1, 8):
        ...
        result_file = "results/ph_{}_nonopt_vampire.txt".format(j)
        print(result_file)
