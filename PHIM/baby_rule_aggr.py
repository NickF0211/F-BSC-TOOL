...
from baby_domain_unbounded import *
...
rule_8 = generate_function(13, max_pid)
rule_9 = generate_function(15, max_pid)
rule_10 = generate_function(20, max_pid)
rule_11 = generate_function(25, max_pid)
...
if __name__ == '__main__':
    ...
    check_property_refining(target_rule, rules, complete_rules, ACTION, state_action, True, vol_bound = 5000,
                            min_solution=mymin, final_min_solution=True, restart=restart, boundary_case = bcr, universal_blocking=ub)
