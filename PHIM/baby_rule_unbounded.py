...
if __name__ == '__main__':
    ...
    start = time.time()
    print(mymin)
    check_property_refining(rule_7, rules, complete_rules, ACTION, state_action, True, vol_bound = 10000, min_solution=mymin, final_min_solution=True, restart=restart, boundary_case = bcr, universal_blocking=ub)
