...
sid = create_type("sid", type_dict, lower_bound = 0, upper_bound = None)
aid = create_type("aid", type_dict, lower_bound = 0, upper_bound = None)
pid = create_type("pid", type_dict, lower_bound = 0, upper_bound = max_pid)
