...
rule_6 = exist(Trans, lambda wd: AND(EQ(wd.amount, Int(4001)), wd.time <= 60))
rule_7 = exist(Trans, lambda wd: AND(EQ(wd.amount, Int(6500)), wd.time <= 60))
...
rule_10 = AND(transfer_protection, exist(Trans, lambda wd: wd.amount > 1500))
