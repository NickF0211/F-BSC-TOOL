...
Balance = create_action("Balance", [ ("amount", "amount"), ("uid", "uid"), ("id", "tid"), ("time", "time")], type_dict)
DTO = create_action("DailyTransferOut", [("amount", "amount"), ("uid", "uid"), ("id", "tid"), ("time", "time")], type_dict)

ACTION = [TimeStamp, Trans, Depo, Withdraw, Balance, DTO]
